...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2019 at 03:13 AM
...
(10, 'vk', 'tg', 'vktg@gmail.com', 'vk12', '9976226787', 'karnatak', 'bangalore', 'nes', 561203),
(11, 'CHIKKA', 'PPAIAH', 'chikka@gmail.com', 'CH12', '9964062927', 'karnataka', 'bangalore', 'nes', 561203);
...
(2, 'avocado', 559),
(3, 'vennila', 400),
(4, 'vennilla cherry', 650),
(5, 'chocolate', 550),
(6, 'ultimate chocolate', 880),
(7, 'chocostar', 700),
(8, 'black forest treat', 880),
(9, 'red valvet', 1000),
(10, 'butterscotch', 639),
(11, 'chococokkie', 600),
(12, 'micky velvet', 950);
...
(151, 2, 9, 2, 'DELIVERED', '2019-11-30 09:57:23'),
...
(162, 2, 1, 2, 'DELIVERED', '2019-11-30 09:57:28'),
(165, 2, 1, 1, 'DELIVERED', '2018-11-12 10:58:53'),
(166, 10, 3, 1, 'DELIVERED', '2019-12-01 08:13:42'),
(167, 10, 3, 1, 'DELIVERED', '2019-12-01 08:13:53'),
(168, 11, 7, 1, 'DELIVERED', '2019-11-30 10:50:57'),
(169, 10, 5, 1, 'DELIVERED', '2019-12-01 08:00:24'),
(170, 10, 7, 1, 'PAYMENT_CONFIRMED', '2019-11-30 16:35:30'),
(171, 10, 6, 2, 'DELIVERED', '2019-12-01 08:00:29'),
(172, 10, 4, 1, 'PAYMENT_CONFIRMED', '2019-11-30 16:35:30'),
(173, 10, 2, 1, 'PAYMENT_CONFIRMED', '2019-12-01 15:49:27');
...
(241, 166, 'CASH_ON_DELIVERY', 'CONFIRMED', '2019-11-30 09:56:21'),
(242, 166, 'CASH_ON_DELIVERY', 'CONFIRMED', '2019-11-30 09:56:21'),
(243, 167, 'CASH_ON_DELIVERY', 'CONFIRMED', '2019-11-30 09:56:21'),
(244, 168, 'CASH_ON_DELIVERY', 'CONFIRMED', '2019-11-30 10:50:13'),
(245, 169, 'CASH_ON_DELIVERY', 'CONFIRMED', '2019-11-30 16:35:30'),
(246, 170, 'CASH_ON_DELIVERY', 'CONFIRMED', '2019-11-30 16:35:30'),
(247, 171, 'CASH_ON_DELIVERY', 'CONFIRMED', '2019-11-30 16:35:30'),
(248, 172, 'CASH_ON_DELIVERY', 'CONFIRMED', '2019-11-30 16:35:30'),
(249, 173, 'CASH_ON_DELIVERY', 'CONFIRMED', '2019-12-01 15:49:27');
...
--
ALTER TABLE `customer`
  MODIFY `customer_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `restaurant`
  MODIFY `restaurant_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1014;
